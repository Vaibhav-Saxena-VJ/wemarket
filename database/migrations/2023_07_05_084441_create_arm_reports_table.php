...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('arm_reports', function (Blueprint $table) {
            ...
            $table->text('meta_title_toc')->nullable();
            $table->text('meta_keyword_toc')->nullable();
            $table->text('meta_description_toc')->nullable();
            $table->text('meta_title_rm')->nullable();
            $table->text('meta_keyword_rm')->nullable();
            $table->text('meta_description_rm')->nullable();
            $table->text('meta_title_rfsp')->nullable();
            $table->text('meta_keyword_rfsp')->nullable();
            $table->text('meta_description_rfsp')->nullable();
