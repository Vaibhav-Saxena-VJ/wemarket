...
Route::get('/sitemap.xml', function () {
    ...
    if (file_exists($filePath)) {
        ...
        // Return response with the file content and appropriate headers
...
Route::get('thankyou', [FrontContactUsEnqueryController::class, 'thankyou']); // 404 Not Found On Get Request
...
// Route::get('/press-release-view/{id}', [BlogController::class, 'show_press_release_details']);
...
Route::post('career-applicant-store',[CareerApplicationController::class, 'store'])->name('career.application.store');
...
Route::group(['prefix' => 'admin', 'middleware' => ['prevent-back-history', 'is_admin']], function () {
    ...
    Route::controller(ReportController::class)->group(function () {
        ...
        Route::get('/report/testing', 'store_report_id');
    });
