                                ...
                                <div class="col-md-12 no-pad">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 form-group no-pad">
                                            <div class="col-md-12">
                                                ...
                                                <img src="{{!empty($report->image_1_path) && Storage::exists($report->image_1_path) ? url('/').Storage::url($report->image_1_path) : URL::asset('admin_panel/commonarea/dist/img/default.png') }}" class="img-select preview_image" alt="{{!empty($report->image_1_name) ? $report->image_1_name : 'User Image';}}">
                                            ...
                                            <div class="col-md-12 mt-10">
                                                ...
                                                <img src="{{!empty($report->image_2_path) && Storage::exists($report->image_2_path) ? url('/').Storage::url($report->image_2_path) : URL::asset('admin_panel/commonarea/dist/img/default.png') }}" class="img-select preview_image1" alt="{{!empty($report->image_2_name) ? $report->image_2_name : 'User Image';}}">
                                            ...
                                            <div class="col-md-12 mt-10">
                                                ...
                                                <img src="{{!empty($report->image_3_path) && Storage::exists($report->image_3_path) ? url('/').Storage::url($report->image_3_path) : URL::asset('admin_panel/commonarea/dist/img/default.png') }}" class="img-select preview_image2" alt="{{!empty($report->image_3_name) ? $report->image_3_name : 'User Image';}}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label class="lablefnt">Meta Description for Description</label>
                                        ...
                                        <div class="col-md-12 form-group pad-right">
                                            <label class="lablefnt">Meta Keyword for Description</label>
                                        ...
                                        <div class="col-md-12 form-group pad-right">
                                            <label class="lablefnt">Meta Title for Description</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label class="lablefnt">Meta Description for Table of Content</label>
                                            <input type="text" class="form-control" id="meta_description_toc" name="meta_description_toc" value="{{ !empty($report->meta_description_toc) ? $report->meta_description_toc : old('meta_description_toc') }}">
                                            @if($errors->has('meta_description_toc'))
                                                <span class="text-danger"><b>*</b> {{$errors->first('meta_description_toc')}}</span>
                                            @endif
                                        </div>
                                        <div class="col-md-12 form-group pad-right">
                                            <label class="lablefnt">Meta Keyword for Table of Content</label>
                                            <input type="text" class="form-control" id="meta_keyword_toc" name="meta_keyword_toc" value="{{ !empty($report->meta_keyword_toc) ? $report->meta_keyword_toc : old('meta_keyword_toc') }}">
                                            @if($errors->has('meta_keyword_toc'))
                                            <span class="text-danger"><b>*</b> {{$errors->first('meta_keyword_toc')}}</span>
                                            @endif
                                        </div>
                                        <div class="col-md-12 form-group pad-right">
                                            <label class="lablefnt">Meta Title for Table of Content</label>
                                            <input type="text" class="form-control" id="meta_title_toc" name="meta_title_toc" value="{{ !empty($report->meta_title_toc) ? $report->meta_title_toc : old('meta_title_toc') }}">
                                            @if($errors->has('meta_title_toc'))
                                                <span class="text-danger"><b>*</b> {{$errors->first('meta_title_toc')}}</span>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label class="lablefnt">Meta Description for Research Mathodology</label>
                                            <input type="text" class="form-control" id="meta_description_rm" name="meta_description_rm" value="{{ !empty($report->meta_description_rm) ? $report->meta_description_rm : old('meta_description_rm') }}">
                                            @if($errors->has('meta_description_rm'))
                                                <span class="text-danger"><b>*</b> {{$errors->first('meta_description_rm')}}</span>
                                            @endif
                                        </div>
                                        <div class="col-md-12 form-group pad-right">
                                            <label class="lablefnt">Meta Keyword for Research Mathodology</label>
                                            <input type="text" class="form-control" id="meta_keyword_rm" name="meta_keyword_rm" value="{{ !empty($report->meta_keyword_rm) ? $report->meta_keyword_rm : old('meta_keyword_rm') }}">
                                            @if($errors->has('meta_keyword_rm'))
                                            <span class="text-danger"><b>*</b> {{$errors->first('meta_keyword_rm')}}</span>
                                            @endif
                                        </div>
                                        <div class="col-md-12 form-group pad-right">
                                            <label class="lablefnt">Meta Title for Research Mathodology</label>
                                            <input type="text" class="form-control" id="meta_title_rm" name="meta_title_rm" value="{{ !empty($report->meta_title_rm) ? $report->meta_title_rm : old('meta_title_rm') }}">
                                            @if($errors->has('meta_title_rm'))
                                                <span class="text-danger"><b>*</b> {{$errors->first('meta_title_rm')}}</span>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label class="lablefnt">Meta Description for Request Free Sample PDF</label>
                                            <input type="text" class="form-control" id="meta_description_rfsp" name="meta_description_rfsp" value="{{ !empty($report->meta_description_rfsp) ? $report->meta_description_rfsp : old('meta_description_rfsp') }}">
                                            @if($errors->has('meta_description_rfsp'))
                                                <span class="text-danger"><b>*</b> {{$errors->first('meta_description_rfsp')}}</span>
                                            @endif
                                        </div>
                                        <div class="col-md-12 form-group pad-right">
                                            <label class="lablefnt">Meta Keyword for Request Free Sample PDF</label>
                                            <input type="text" class="form-control" id="meta_keyword_rfsp" name="meta_keyword_rfsp" value="{{ !empty($report->meta_keyword_rfsp) ? $report->meta_keyword_rfsp : old('meta_keyword_rfsp') }}">
                                            @if($errors->has('meta_keyword_rfsp'))
                                            <span class="text-danger"><b>*</b> {{$errors->first('meta_keyword_rfsp')}}</span>
                                            @endif
                                        </div>
                                        <div class="col-md-12 form-group pad-right">
                                            <label class="lablefnt">Meta Title for Request Free Sample PDF</label>
                                            <input type="text" class="form-control" id="meta_title_rfsp" name="meta_title_rfsp" value="{{ !empty($report->meta_title_rfsp) ? $report->meta_title_rfsp : old('meta_title_rfsp') }}">
                                            @if($errors->has('meta_title_rfsp'))
                                                <span class="text-danger"><b>*</b> {{$errors->first('meta_title_rfsp')}}</span>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            ...
                                            <textarea class="form-control" id="schema_markup" name="schema_markup" rows="5">{{ old('schema_markup', !empty($report->schema_markup) ? $report->schema_markup : '') }}</textarea>
                                        ...
                                        <div class="col-md-12 form-group">
                                            ...
                                            <textarea class="form-control" id="og_meta" name="og_meta" rows="5">{{ old('og_meta', !empty($report->og_meta) ? $report->og_meta : '') }}</textarea>
                                        ...
                                        <div class="col-md-12 form-group">
                                            ...
                                            <textarea class="form-control" id="twitter_meta" name="twitter_meta" rows="5">{{ old('twitter_meta', !empty($report->twitter_meta) ? $report->twitter_meta : '') }}</textarea>
