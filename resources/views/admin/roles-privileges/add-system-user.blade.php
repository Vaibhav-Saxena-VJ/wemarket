                    ...
                    <form action="{{ route('system-user.store') }}" method="post" id="add-system-user-form" enctype="multipart/form-data">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <img src="{{!empty($system_user_details->user_profile_image_path) && Storage::exists($system_user_details->user_profile_image_path) ? url('/').Storage::url($system_user_details->user_profile_image_path) : URL::asset('admin_panel/commonarea/dist/img/default.png') }}" class="img-select preview_image" alt="{{!empty($system_user_details->user_profile_image_name) ? $system_user_details->user_profile_image_name :'User Image';}}">
