                                ...
                                <div class="row ">
                                   ...
                                   <form action="{{route('home.store')}}" class="form-validate is-alter"  method="POST" id="system_users_form" enctype="multipart/form-data">
                                        ...
                                        <div class="col-sm-4 form-group no-pad-left ">
                                            ...
                                            <img src="{{!empty($home->section_2_image_path) ? url('/').Storage::url($home->section_2_image_path) : URL::asset('admin_panel/commonarea/dist/img/default.png') }}" class="img-select preview_image1" alt="{{!empty($user->user_profile_image_name) ? $user->user_profile_image_name : 'User Image';}}">
                                        </div>
                                        <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                       ...
                                       <form action="{{route('home.store')}}" class="form-validate is-alter"  method="POST" id="system_users_form" enctype="multipart/form-data">
                                        ...
                                        <div class="col-sm-4 form-group no-pad-left ">
                                            ...
                                            <div class="clearfix"></div>
                                            <img src="{{!empty($home->section_3_image_path) ? url('/').Storage::url($home->section_3_image_path) : URL::asset('admin_panel/commonarea/dist/img/default.png') }}" class="img-select preview_image4" alt="{{!empty($home->section_3_image_name) ? $home->section_3_image_path: 'User Image';}}">
                                            <div class="clearfix"></div>
                                        </div>
                                        <div class="col-md-12">
                                  ...
                                  <form action="{{route('home.store')}}" class="form-validate is-alter"  method="POST" id="system_users_form" enctype="multipart/form-data">
                                        ...
                                        <div class="col-sm-4 form-group no-pad-left ">
                                            <div class="col-md-12">
                                                ...
                                                <div class="clearfix"></div>
                                                <img src="{{!empty($home->section_4_image_1_path) ? url('/').Storage::url($home->section_4_image_1_path) : URL::asset('admin_panel/commonarea/dist/img/default.png') }}" class="img-select preview_image5" alt="{{!empty($user->section_4_image_1_name) ? $user->section_4_image_1_name: 'User Image';}}">
                                                <div class="clearfix"></div>
                                            </div>
                                            <div class="col-md-12 mt-20">
                                                ...
                                                <div class="clearfix"></div>
                                                <img src="{{!empty($home->section_4_image_2_path) ? url('/').Storage::url($home->section_4_image_2_path) : URL::asset('admin_panel/commonarea/dist/img/default.png') }}" class="img-select preview_image6" alt="{{!empty($home->section_4_image_2_name) ? $home->section_4_image_2_name: 'User Image';}}">
                                                <div class="clearfix"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-12 ">
                                ...
                                <form action="{{route('home.store')}}" class="form-validate is-alter"  method="POST" id="system_users_form" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 form-group">
                                            ...
                                            <textarea class="form-control" id="schema_markup" name="schema_markup" rows="5">{{ old('schema_markup', !empty($home->schema_markup) ? $home->schema_markup : '') }}</textarea>
                                        ...
                                        <div class="col-md-12 form-group">
                                            ...
                                            <textarea class="form-control" id="og_meta" name="og_meta" rows="5">{{ old('og_meta', !empty($home->og_meta) ? $home->og_meta : '') }}</textarea>
                                        ...
                                        <div class="col-md-12 form-group">
                                            ...
                                            <textarea class="form-control" id="twitter_meta" name="twitter_meta" rows="5">{{ old('twitter_meta', !empty($home->twitter_meta) ? $home->twitter_meta : '') }}</textarea>
