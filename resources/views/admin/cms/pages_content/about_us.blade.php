                                ...
                                <div class="row">
                                    ...
                                    <form action="{{route('about.store')}}" class="form-validate is-alter"  method="POST" id="system_users_form" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <img src="{{!empty($about->section_1_image_path) ?url('/').Storage::url($about->section_1_image_path) : URL::asset('admin_panel/commonarea/dist/img/default.png') }}" class="img-select preview_image" alt="{{!empty($about->section_1_image_name) ? $about->section_1_image_path : 'Default Image';}}">
                                            <div class="clearfix"></div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 form-group">
                                                    ...
                                                    <div class="clearfix"></div>
                                                    <img src="{{!empty($why_us_content->content_image_path) ?url('/').Storage::url($why_us_content->content_image_path) : URL::asset('admin_panel/commonarea/dist/img/default.png') }}" class="img-select preview_image1" alt="{{!empty($why_us_content->content_image_name) ? $why_us_content->content_image_path: 'User Image';}}">
                                                    <div class="clearfix"></div>
                                                </div>
                               ...
                               <form action="{{route('about.store')}}" class="form-validate is-alter" autocomplete="off" method="POST" id="system_users_form" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 form-group">
                                            ...
                                            <input type="text" class="form-control" id="meta_keyword" name="meta_keyword" value="{{old('meta_keyword',!empty($about->meta_keyword)?$about->meta_keyword:'')}}">
                                        </div>
                                        ...
                                        <div class="col-md-12 form-group">
                                            ...
                                            <textarea class="form-control" id="schema_markup" name="schema_markup" rows="5">{{ old('schema_markup', !empty($about->schema_markup) ? $about->schema_markup : '') }}</textarea>
                                        ...
                                        <div class="col-md-12 form-group">
                                            ...
                                            <textarea class="form-control" id="og_meta" name="og_meta" rows="5">{{ old('og_meta', !empty($about->og_meta) ? $about->og_meta : '') }}</textarea>
                                        ...
                                        <div class="col-md-12 form-group">
                                            ...
                                            <textarea class="form-control" id="twitter_meta" name="twitter_meta" rows="5">{{ old('twitter_meta', !empty($about->twitter_meta) ? $about->twitter_meta : '') }}</textarea>
