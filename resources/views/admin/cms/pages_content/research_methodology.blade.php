                                    ...
                                    <form action="{{route('research.methodology.store')}}" class="form-validate is-alter" autocomplete="off" method="POST" id="system_users_form" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <div class="clearfix"></div>
                                                    <img src="{{!empty($research->section_4_image_path_1) ?url('/').Storage::url($research->section_4_image_path_1) : URL::asset('admin_panel/commonarea/dist/img/default.png') }}" class="img-select preview_image" alt="{{!empty($research->section_4_image_name_1) ? $research->section_4_image_name_1: 'Default Image';}}">
                                                    <div class="clearfix"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4 no-pad">
                                            ...
                                            <div class="col-md-12 form-group">
                                                ...
                                                <img src="{{!empty($research->section_4_image_path_2) ?url('/').Storage::url($research->section_4_image_path_2) : URL::asset('admin_panel/commonarea/dist/img/default.png') }}" class="img-select preview_image1" alt="{{!empty($research->section_4_image_name_2) ? $research->section_4_image_name_2: 'Default Image';}}">
                                                <div class="clearfix"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-4 no-pad">
                                            ...
                                            <div class="col-md-12 form-group">
                                                ...
                                                <div class="clearfix"></div>
                                                <img src="{{!empty($research->section_4_image_path_3) ?url('/').Storage::url($research->section_4_image_path_3) : URL::asset('admin_panel/commonarea/dist/img/default.png') }}" class="img-select preview_image2" alt="{{!empty($research->section_4_image_name_3) ? $research->section_4_image_name_3 : 'Default Image';}}">
                                                <div class="clearfix"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-4 no-pad">
                                            ...
                                            <div class="col-md-12 form-group">
                                                ...
                                                <div class="clearfix"></div>
                                                <img src="{{!empty($research->section_4_image_path_4) ?url('/').Storage::url($research->section_4_image_path_4) : URL::asset('admin_panel/commonarea/dist/img/default.png') }}" class="img-select preview_image3" alt="{{!empty($research->section_4_image_name_4) ? $research->section_4_image_name_4: 'Default Image';}}">
                                                <div class="clearfix"></div>
                                            </div>
                                        </div>
