                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group">
                                <div class="upload_img">
                                    ...
                                    <img src="{{!empty($testimonial->image_path) && Storage::exists($testimonial->image_path) ? url('/').Storage::url($testimonial->image_path) : URL::asset('admin_panel/commonarea/dist/img/default.png') }}" class="img-select preview_image" alt="{{!empty($testimonial->image_name) ? $testimonial->image_name : 'User Image';}}">
