                        ...
                        <form action="{{url('admin/category/store')}}" method="post" id="category_form" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <input type="text" name="category_icon" id="category_icon" class="form-control" value="{{!empty($reportCategory->category_icon) ? $reportCategory->category_icon : old('category_icon');}}" autocomplete="off">
                                    @if($errors->has('category_icon'))
                                    <span class="text-danger"><b>*</b> {{$errors->first('category_icon')}}</span>
                                    @endif
                                </div>
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <img src="{{!empty($reportCategory->image_path) && Storage::exists($reportCategory->image_path) ? url('/').Storage::url($reportCategory->image_path) : URL::asset('admin_panel/commonarea/dist/img/default.png') }}" class="img-select preview_image" alt="{{!empty($reportCategory->image_name) ? $reportCategory->image_name : 'User Image';}}">
                                ...
                                <input type="hidden" class="form-control" id="schema_markup" name="schema_markup" value="{{ !empty($reportCategory->schema_markup) ? $reportCategory->schema_markup : old('schema_markup') }}">
                                <input type="hidden" class="form-control" id="og_meta" name="og_meta" value="{{ !empty($reportCategory->og_meta) ? $reportCategory->og_meta : old('og_meta') }}">
                                <input type="hidden" class="form-control" id="twitter_meta" name="twitter_meta" value="{{ !empty($reportCategory->twitter_meta) ? $reportCategory->twitter_meta : old('twitter_meta') }}">
                        ...
                        <form action="{{url('admin/category/store')}}" method="post" id="category_form" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <textarea class="form-control" id="schema_markup" name="schema_markup" rows="5">{{ old('schema_markup', !empty($reportCategory->schema_markup) ? $reportCategory->schema_markup : '') }}</textarea>
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <textarea class="form-control" id="og_meta" name="og_meta" rows="5">{{ old('og_meta', !empty($reportCategory->og_meta) ? $reportCategory->og_meta : '') }}</textarea>
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <textarea class="form-control" id="twitter_meta" name="twitter_meta" rows="5">{{ old('twitter_meta', !empty($reportCategory->twitter_meta) ? $reportCategory->twitter_meta : '') }}</textarea>
