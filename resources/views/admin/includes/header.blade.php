...
<head>
    ...
    <!-- <link rel="icon" href="{{ !empty($favicon_image->favicon_image_path) ? $favicon_image->favicon_image_path : URL::asset('admin_panel/commonarea/dist/img/default.png') }}" type="image/png" sizes="16x16"> -->
