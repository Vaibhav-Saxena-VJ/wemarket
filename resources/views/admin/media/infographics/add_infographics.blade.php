                ...
                <div class="box box-primary">
                    <div class="box-body light-green-body" style="min-height: 210px;">
                        ...
                        <div class="col-md-4 no-padd-left">
                            ...
                            <img src="{{!empty($infographics->image_path) ? url('/').Storage::url($infographics->image_path) : URL::asset('admin_panel/commonarea/dist/img/default.png') }}" class="img-select preview_image" alt="{{!empty($infographics->image_name) ? $infographics->image_name : 'Infographics Image';}}">
                    ...
                    <form action="{{route('infographics.store')}}" class="form-validate is-alter" autocomplete="off" method="POST" id="system_users_form" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <textarea class="form-control" id="schema_markup" name="schema_markup" rows="5">{{ old('schema_markup', !empty($infographics->schema_markup) ? $infographics->schema_markup : '') }}</textarea>
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <textarea class="form-control" id="og_meta" name="og_meta" rows="5">{{ old('og_meta', !empty($infographics->og_meta) ? $infographics->og_meta : '') }}</textarea>
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <textarea class="form-control" id="twitter_meta" name="twitter_meta" rows="5">{{ old('twitter_meta', !empty($infographics->twitter_meta) ? $infographics->twitter_meta : '') }}</textarea>
