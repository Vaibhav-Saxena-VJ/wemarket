                        ...
                        <div class="col-md-4 no-pad">
                            <div class="row">
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <img src="{{!empty($user->user_profile_image_path) ? Storage::url($user->user_profile_image_path) : URL::asset('admin_panel/commonarea/dist/img/default.png') }}" class="img-select preview_image" alt="{{!empty($user->user_profile_image_name) ? $user->user_profile_image_name : 'User Image';}}">
                                </div>
                                <div class="clearfix"></div>
                                <div class="col-md-12 form-group">
                                    <div class="buttons">
