            ...
            <form action="{{route('blog.store')}}" method="post" id="blog_form" enctype="multipart/form-data">
                ...
                <div class="box box-primary">
                    <div class="box-body light-green-body" style="min-height: 375px;">
                        <div class="col-md-4 no-pad-left">
                            <div class="row">
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <img src="{{!empty($blog->image_path) ? url('/').Storage::url($blog->image_path) : URL::asset('admin_panel/commonarea/dist/img/default.png') }}" class="img-select preview_image" alt="{{!empty($blog->image_name) ? $blog->image_name :'User Image';}}">
                        ...
                        <div class="col-md-12 form-group">
                            <div class="buttons">
                                <button type="submit" name="blog" class="btn btn-success save_btn submit" data-id="submit"><i class="fa fa-check-circle"></i>{{!empty($blog)?'Update':'Add'}}</button>
                    ...
                    <input type="hidden" name="id" value="{{!empty($blog->id)?$blog->id:''}}">
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <textarea class="form-control" id="schema_markup" name="schema_markup" rows="5">{{ old('schema_markup', !empty($blog->schema_markup) ? $blog->schema_markup : '') }}</textarea>
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <textarea class="form-control" id="og_meta" name="og_meta" rows="5">{{ old('og_meta', !empty($blog->og_meta) ? $blog->og_meta : '') }}</textarea>
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <textarea class="form-control" id="twitter_meta" name="twitter_meta" rows="5">{{ old('twitter_meta', !empty($blog->twitter_meta) ? $blog->twitter_meta : '') }}</textarea>
