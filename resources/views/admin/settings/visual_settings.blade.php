                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div style="margin-bottom: 10px;">
                                        <img src="{{ !empty($visual_settings->logo_image_path) && Storage::exists($visual_settings->logo_image_path) ? url('/').Storage::url($visual_settings->logo_image_path) : URL::asset('admin_panel/commonarea/dist/img/default.png') }}" alt="{{ !empty($visual_settings->logo_image_name) ? $visual_settings->logo_image_name : 'Logo Image' }}" style="max-width: 160px; max-height: 160px;" class="preview_image">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div style="margin-bottom: 10px;">
                                        <img src="{{ !empty($visual_settings->mini_logo_image_path) && Storage::exists($visual_settings->mini_logo_image_path) ? url('/').Storage::url($visual_settings->mini_logo_image_path) : URL::asset('admin_panel/commonarea/dist/img/default.png') }}" alt="{{ !empty($visual_settings->mini_logo_image_name) ? $visual_settings->mini_logo_image_name : 'Mini Logo Image' }}" style="max-width: 160px; max-height: 160px;" class="preview_image4">
                                    </div>
                                    <div class="display-block">
                                        <a class="btn btn-success btn-sm btn-file-upload">
                                            Select Logo
                                ...
                                <div class="form-group">
                                    ...
                                    <div style="margin-bottom: 10px;">
                                        <img src="{{ !empty($visual_settings->logo_email_image_path) && Storage::exists($visual_settings->logo_email_image_path) ? url('/').Storage::url($visual_settings->logo_email_image_path) : URL::asset('admin_panel/commonarea/dist/img/default.png') }}" alt="{{ !empty($visual_settings->logo_email_image_name) ? $visual_settings->logo_email_image_name : 'Email Logo Image' }}" style="max-width: 160px; max-height: 160px;" class="preview_image2">
                                    </div>
                                    <div class="display-block">
                                        <a class="btn btn-success btn-sm btn-file-upload">
                                            Select Logo Email
                                ...
                                <div class="form-group">
                                    ...
                                    <div style="margin-bottom: 10px;">
                                        <img src="{{ !empty($visual_settings->favicon_image_path) && Storage::exists($visual_settings->favicon_image_path) ? url('/').Storage::url($visual_settings->favicon_image_path) : URL::asset('admin_panel/commonarea/dist/img/default.png') }}" alt="{{ !empty($visual_settings->favicon_image_name) ? $visual_settings->favicon_image_name : 'Favicon Image' }}" style="max-width: 160px; max-height: 160px;" class="preview_image3">
                                    </div>
                                    <div class="display-block">
                                        <a class="btn btn-success btn-sm btn-file-upload">
                                            Select Favicon
