...
<div class="container pt-30">
    <div class="row">
        ...
        <div class="col-md-6 col-12 iq-icon-box iq-icon-box-style-5  bg-white iq-box-shadow wow fadeInUp" data-wow-duration="0.7s" style="visibility: visible; animation-duration: 0.7s; animation-name: fadeInUp;">
        ...
        <div class="col-md-6 col-12 mt-0 single-form-page {{ Session::has('success') ? 'd-none' : '' }}">
            <div class="report_form_card_page">
                ...
                <form action="{{ route('report.enquiry.store') }}" method="post" id="sample_request_form">
                    ...
                    <div class="report_form_field form-msg-box">
                        ...
                        <span class="wpcf7-form-control-wrap your-message"><textarea id="message" name="message" cols="46" rows="12" class="wpcf7-form-control wpcf7-textarea" aria-invalid="false" placeholder="Message">{{ old('message') }}</textarea></span>
                    </div>
