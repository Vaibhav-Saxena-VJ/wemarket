...
@section('meta_keywords',!empty($about->meta_keyword)?$about->meta_keyword:'')

@section('meta_description', !empty($about->meta_description)?$about->meta_description:'')
@section('head')
<meta name='robots' content='index,follow, max-image-preview:large/' />
{!! !empty($about->schema_markup)?$about->schema_markup:'' !!}
{!! !empty($about->og_meta)?$about->og_meta:'' !!}
{!! !empty($about->twitter_meta)?$about->twitter_meta:'' !!}
@endsection
@section('content')
   ...
   <div class="container">
      <div class="row">
         <div class="col-lg-6 col-sm-12 mb-lg-0 mb-4 wow fadeInLeft">
            <img src="{{!empty($about->section_1_image_path) && (Storage::exists($about->section_1_image_path)) ? url('/').Storage::url($about->section_1_image_path) : URL::asset('admin_panel/commonarea/dist/img/default1.jpg')}}" class="img-fluid w-100 border-r5" alt="{{!empty($about->section_1_image_name)?$about->section_1_image_name:''}}" />
         </div>
            ...
            <div class="wcu-card-div">
               @foreach ($why_us_content as $data)
                  ...
                  <div class="wcu-card-img">
                     <img src="{{!empty($data->content_image_path) && Storage::exists($data->content_image_path) ? url('/').Storage::url($data->content_image_path) : URL::asset('admin_panel/commonarea/dist/img/default1.jpg')}}" class="img-fluid" alt="{{!empty($data->content_image_path)?$data->content_image_path:''}}">
                  </div>
