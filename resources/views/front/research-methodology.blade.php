                        ...
                        <div class=" text-left iq-title-default iq-title-box-2 ">
                            ...
                            <div class="iq-icon-box iq-icon-box-style-5 bg-white iq-box-shadow border-bottom-box">
                                <div class="icon-box-img">
                                    <img src="{{!empty($research->section_4_image_path_1) && Storage::exists($research->section_4_image_path_1) ? url('/').Storage::url($research->section_4_image_path_1) : URL::asset('admin_panel/commonarea/dist/img/default1.jpg')}}" class="img-fluid w-100" alt="{{!empty($research->section_4_image_name_1)?$research->section_4_image_name_1:'default image'}}">
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 wow fadeInUp" data-wow-duration="1.1s">
                                    <div class="iq-icon-box iq-icon-box-style-1">
                                        <div class="icon-box-img">
                                            <img src="{{!empty($research->section_4_image_path_2) && Storage::exists($research->section_4_image_path_2) ? url('/').Storage::url($research->section_4_image_path_2) : URL::asset('admin_panel/commonarea/dist/img/default1.jpg')}}" class="img-fluid" alt="{{!empty($research->section_4_image_name_2)?$research->section_4_image_name_2:'default image'}}">
                                        </div>
                                ...
                                <div class="col-md-4 wow fadeInUp" data-wow-duration="1.3s">
                                    <div class="iq-icon-box iq-icon-box-style-1">
                                        <div class="icon-box-img">
                                            <img src="{{!empty($research->section_4_image_path_3) && Storage::exists($research->section_4_image_path_3) ?url('/').Storage::url($research->section_4_image_path_3) : URL::asset('admin_panel/commonarea/dist/img/default1.jpg')}}" class="img-fluid" alt="{{!empty($research->section_4_image_name_3)?$research->section_4_image_name_3:'default image'}}">
                                        </div>
                                        <div class="icon-box-content">
                                ...
                                <div class="col-md-4 wow fadeInUp" data-wow-duration="1.5s">
                                    <div class="iq-icon-box iq-icon-box-style-1">
                                        <div class="icon-box-img">
                                            <img src="{{!empty($research->section_4_image_path_4) && Storage::exists($research->section_4_image_path_4) ?url('/').Storage::url($research->section_4_image_path_4) : URL::asset('admin_panel/commonarea/dist/img/default1.jpg')}}" class="img-fluid" alt="{{!empty($research->section_4_image_name_4)?$research->section_4_image_name_4:'default image'}}">
                                        </div>
                                        <div class="icon-box-content">
                                    ...
                                    @foreach ($banner as $bannerData )
                                        <div class="item">
                                            <div class="landing-page-slider">
                                                <img src="{{!empty($bannerData->image_path) && Storage::exists($bannerData->image_path) ? url('/').Storage::url($bannerData->image_path) : URL::asset('admin_panel/commonarea/dist/img/default1.jpg')}}" alt="">
                                            </div>
                                        </div>   
                                    @endforeach
                                @endif
