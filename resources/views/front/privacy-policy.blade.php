...
@section('meta_keywords',!empty($privacy->meta_keyword)?$privacy->meta_keyword:'')

@section('meta_description', !empty($privacy->meta_description)?$privacy->meta_description:'')
@section('head')
<meta name='robots' content='index,follow, max-image-preview:large/' />
{!! !empty($privacy->schema_markup)?$privacy->schema_markup:'' !!}
{!! !empty($privacy->og_meta)?$privacy->og_meta:'' !!}
{!! !empty($privacy->twitter_meta)?$privacy->twitter_meta:'' !!}
@endsection
@section('content')
<!-- Breadcrumb Start -->
<div class=" main-bg">
