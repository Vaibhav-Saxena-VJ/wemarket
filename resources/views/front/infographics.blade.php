                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            <a href="{{url('infographics-details/'.(!empty($infoData->id)?$infoData->id:''))}}">
                                <img src="{{!empty($infoData->image_path) && Storage::exists($infoData->image_path) ? url('/').Storage::url($infoData->image_path) : URL::asset('admin_panel/commonarea/dist/img/default1.jpg')}}" alt="{{ !empty($infoData->image_name)?$infoData->image_name:'' }}">
                                <div class="content">
