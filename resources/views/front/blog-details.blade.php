...
@section('meta_keywords',!empty($blog_details->meta_keyword)?$blog_details->meta_keyword:'')

@section('meta_description', !empty($blog_details->meta_description)?$blog_details->meta_description:'')

@section('head')
<meta name='robots' content='index,follow, max-image-preview:large/' />
{!! !empty($blog_details->schema_markup)?$blog_details->schema_markup:''  !!}
{!! !empty($blog_details->og_meta)?$blog_details->og_meta:'' !!}
{!! !empty($blog_details->twitter_meta)?$blog_details->twitter_meta:'' !!}
@endsection
@section('content')
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 mt-lg-0 mt-5">
                <div class="iq-blog-box">
                    {{-- <div class="iq-blog-image clearfix">
                         <img src="{{!empty($blog_details->image_path) && (Storage::exists($blog_details->image_path)) ? url('/').Storage::url($blog_details->image_path) : URL::asset('admin_panel/commonarea/dist/img/default1.jpg')}}" class="img-fluid" alt="qloud" />
                    </div> --}}
                      ...
                      <a href="{{url('blog/'.(!empty($recentBlog->slug_url)?$recentBlog->slug_url:'#'))}}">
                        <div class="iq-icon-box iq-icon-box-style-2 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                            <div class="icon-box-img">
                                <img src="{{!empty($recentBlog->image_path) && Storage::exists($recentBlog->image_path) ? url('/').Storage::url($recentBlog->image_path) : URL::asset('admin_panel/commonarea/dist/img/default1.jpg')}}" class="w-100 img-fluid" alt="qloud">
                            </div>
