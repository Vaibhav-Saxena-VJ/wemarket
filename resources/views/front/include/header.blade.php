...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('front/images/we-favicon.ico') }}" />
                ...
                <div class="col-sm-12">
                    <nav id="navbar" class="navbar navbar-expand-lg navbar-light nav-page">
                        <a class="navbar-brand" href="{{URL::asset('/')}}">
                            ...
                            @endphp
                            <img src="{{ !empty($logo_image->logo_image_path) && Storage::exists($logo_image->logo_image_path) ? url('/').Storage::url($logo_image->logo_image_path) : URL::asset('admin_panel/commonarea/dist/img/default.png') }}" alt="{{ !empty($logo_image->logo_image_name) ? $logo_image->logo_image_name : 'Logo Image' }}" style="max-width: 160px; max-height: 160px;">
                            <!-- <img class="img-fluid" src="{{ URL::asset('front/images/we-logo.png') }}" alt="img"> -->
                        </a>
                            ...
                            <ul class="navbar-nav mr-auto w-100 justify-content-end">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown-2">
                                        ...
                                        <!--<a class="dropdown-item we-market-knowledge-active" href="{{url('services/subscription')}}">Subscription - We Market Knowledge Base</a>-->
                                ...
                                <li class="nav-item dropdown for-desktop-reports">
                                    <a class="nav-link dropdown-toggle reports_active" href="{{ url('/research-reports/all') }}" id="">
                                        Reports
                                    </a>
                                    <div class="dropdown-menu reports-headers" aria-labelledby="navbarDropdown-2">
                                        @if(!empty($reportCategories))
                                        ...
                                        <div class="d-flex align-items-center">
                                            <i class="{{ !empty($category->category_icon) ? $category->category_icon : '' }}" aria-hidden="true"></i>
                            ...
                            <div class="searchBox search-for-desktop">
                                <form action="{{ url('/searchresults') }}" method="get" id="filter_input_form">
                                    ...
                                    <div class="nav-search-box-div" id="mySearchDiv">
                                        <input class="searchInput" type="text" name="filter" placeholder="Search Reports" value="{{ !empty($filter_text) ? $filter_text : old('filter') }}" placeholder="Search something">
