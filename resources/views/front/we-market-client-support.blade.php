...
@section('meta_keywords',!empty($service->meta_keyword)?$service->meta_keyword:'')

@section('meta_description', !empty($service->meta_description)?$service->meta_description:'')

@section('content')
@section('head')
<meta name='robots' content='index,follow, max-image-preview:large/' />
{!! !empty($service->schema_markup)?$service->schema_markup:''!!}
{!! !empty($service->og_meta)?$service->og_meta:'' !!}
{!! !empty($service->twitter_meta)?$service->twitter_meta:'' !!}
@endsection
<!-- Breadcrumb Start -->
<div class=" main-bg">
...
<section class="pt-0">
    <div class="iq-blog-section service-view">
        <div class="service-view-img">
            <img src="{{!empty($service->banner_image_path) && Storage::exists($service->banner_image_path) ? url('/').Storage::url($service->banner_image_path) : URL::asset('admin_panel/commonarea/dist/img/default1.jpg')}}" class="img-fluid w-100 service-view-img" alt="Forbes">
        </div>
        <div class="container">
