                ...
                <div class="service-card">
                    <a href="{{url('/services/consulting')}}">
                        <div class="service-card-img">
                            <img src="{{!empty($service1->banner_image_path) && Storage::exists($service1->banner_image_path) ? url('/').Storage::url($service1->banner_image_path) : URL::asset('admin_panel/commonarea/dist/img/default1.jpg')}}" class="img-fluid w-100" alt="Forbes">
                        </div>
            ...
            <div class="col-lg-4 mb-5 wow fadeInLeft" data-wow-duration="0.8s">
                <div class="service-card">
                    <a href="{{url('/services/subscription')}}">
                        <div class="service-card-img">
                            <img src="{{!empty($service2->banner_image_path) && Storage::exists($service2->banner_image_path) ?url('/').Storage::url($service2->banner_image_path) : URL::asset('admin_panel/commonarea/dist/img/default1.jpg')}}" class="img-fluid w-100" alt="Forbes">
                        </div>
                        <div class="service-card-details">
            ...
            <div class="col-lg-4 mb-5 wow fadeInLeft" data-wow-duration="1s">
                <div class="service-card">
                    <a href="{{url('/services/custom-market-research')}}">
                        <div class="service-card-img">
                            <img  src="{{!empty($service3->banner_image_path) && Storage::exists($service3->banner_image_path) ? url('/').Storage::url($service3->banner_image_path) : URL::asset('admin_panel/commonarea/dist/img/default1.jpg')}}" class="img-fluid w-100" alt="Forbes">
                        </div>
                        <div class="service-card-details">
            ...
            <div class="col-lg-4 mb-5 wow fadeInLeft" data-wow-duration="1.2s">
                <div class="service-card">
                    <a href="{{url('/services/we-market-client-support')}}">
                        <div class="service-card-img">
                            <img  src="{{!empty($service4->banner_image_path) && Storage::exists($service4->banner_image_path) ? url('/').Storage::url($service4->banner_image_path) : URL::asset('admin_panel/commonarea/dist/img/default1.jpg')}}" class="img-fluid w-100" alt="Forbes">
                        </div>
                        <div class="service-card-details">
