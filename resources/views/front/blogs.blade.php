            ...
            <div class="col-lg-4 col-md-6 qloud-space-bottom ">
                <div class="iq-blog-box" style="border: 1px solid #0071a1">
                    <div class="iq-blog-image clearfix">
                        {{-- <img src="{{!empty($blog->image_path) && (Storage::exists($blog->image_path)) ? url('/').Storage::url($blog->image_path) : URL::asset('admin_panel/commonarea/dist/img/default1.jpg') }}" class="img-fluid" alt="unisaas-blog"> --}}
                        <ul class="iq-blogtag">
                            @php
