...
@if(Request::is('*toc/*')==true)
    @section('title',!empty($report_details->meta_title_toc)?$report_details->meta_title_toc:'')
    @section('meta_keywords',!empty($report_details->meta_keyword_toc)?$report_details->meta_keyword_toc:'')
    @section('meta_description', !empty($report_details->meta_description_toc)?$report_details->meta_description_toc:'')
    @section('head') <meta name='robots' content='index,follow, max-image-preview:large/' /> @endsection
@elseif(Request::is('*research-methodology/*')==true)
    @section('title',!empty($report_details->meta_title_rm)?$report_details->meta_title_rm:'')
    @section('meta_keywords',!empty($report_details->meta_keyword_rm)?$report_details->meta_keyword_rm:'')
    @section('meta_description', !empty($report_details->meta_description_rm)?$report_details->meta_description_rm:'')
    @section('head') <meta name='robots' content='index,follow, max-image-preview:large/' /> @endsection
@elseif(Request::is('*request-free-sample-pdf/*')==true)
    @section('title',!empty($report_details->meta_title_rfsp)?$report_details->meta_title_rfsp:'')
    @section('meta_keywords',!empty($report_details->meta_keyword_rfsp)?$report_details->meta_keyword_rfsp:'')
    @section('meta_description', !empty($report_details->meta_description_rfsp)?$report_details->meta_description_rfsp:'')
    @section('head') <meta name='robots' content='index,follow, max-image-preview:large/' /> @endsection
@elseif(Request::is('*reports/*')==true)
    @section('title',!empty($report_details->meta_title)?$report_details->meta_title:'')
    @section('meta_keywords',!empty($report_details->meta_keyword)?$report_details->meta_keyword:'')
    @section('meta_description', !empty($report_details->meta_description)?$report_details->meta_description:'')
    @section('head')
        <meta name='robots' content='index,follow, max-image-preview:large/' />
        {!! !empty($report_details->og_meta)?$report_details->og_meta:'' !!}
        {!! !empty($report_details->twitter_meta)?$report_details->twitter_meta:'' !!}
        {!! !empty($report_details->schema_markup)?$report_details->schema_markup:''!!}
    @endsection
@endif
                ...
                <div class="row align-items-center">
                    <div class="col-sm-12">
                        <nav aria-label="breadcrumb" class="text-center iq-breadcrumb-two">
                            <h1 class="title">{{ !empty($report_details->title) ? App\Helpers\Helpers\Helper::getFirstFiveWords($report_details->title) : '' }}</h1>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                <div class="report-view-heading  wow fadeInLeft">
                    <div class="report-header-div">
                        <div class="report-view_img">
                            {{-- <img src="{{ !empty($report_details->image_1_path) && Storage::exists($report_details->image_1_path) ? url('/').Storage::url($report_details->image_1_path) : URL::asset('admin_panel/commonarea/dist/img/default1.jpg') }}" class="w-100 report-view-img" alt="Forbes"> --}}
                        ...
                        <div class="report-view_details">
                            <h2 style="padding-bottom: 10px;font-size: 20px;">{{ !empty($report_details->title) ? $report_details->title : '' }}</h2>
                                            ...
                                            <div class="report_form_card_page">
                                                ...
                                                <form action="{{ route('report.enquiry.store') }}" method="post" id="sample_request_form">
                                                    ...
                                                    <div class="report_form_field">
                                                        ...
                                                        <input type="text" id="designation" name="designation" class="report_form_input-field" placeholder="Designation" value="{{ old('designation') }}">
                                                    </div>
                ...
                <div class="report-view-faq {{$hideclass}} " id="faq-section">
                    <div class="row">
                        <div class="col-lg-12">
                    ...
                    <a href="{{ url('/reports/'.$related_report->reports->url.'/'.$related_report->reports->id) }}">
                        <div class="iq-icon-box iq-icon-box-style-2 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                            <div class="icon-box-img">
                                {{-- <img src="{{ !empty($related_report->image_1_path) && Storage::exists($related_report->image_1_path) ? URL('/').Storage::url($related_report->image_1_path) :  URL::asset('admin_panel/commonarea/dist/img/default1.jpg') }}" class="w-100 img-fluid" alt="{{ !empty($related_report->image_1_name) ? $related_report->image_1_path : '' }}"> --}}
                                <img src="{{ URL::asset('admin_panel/commonarea/dist/img/default1.jpg') }}" class="w-100 img-fluid" alt="report-image">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="iq-price-container iq-price-table-6 text-center iq-box-shadow wow fadeInUp" data-wow-duration="1.8s">
                                    ...
                                    <div class="iq-price-footer">
                                        <div class="iq-btn-container">
                                            <a href="{{ url('/purchase/'.$report_details->url.'/'.$report_details->id.'?license=enterprise') }}" class="iq-button iq-btn-round d-inline" id="license_type_button_3" value="enterprise"> Buy Now </a>
                                        </div>
                                    </div>
                                    <div class="iq-price-body">
                                        <ul class="iq-price-service">
