...
@section('meta_keywords',!empty($home->meta_keyword)?$home->meta_keyword:'')

@section('meta_description', !empty($home->meta_description)?$home->meta_description:'')
@section('head')
<meta name='robots' content='index,follow, max-image-preview:large/' />

{!! !empty($home->schema_markup)?$home->schema_markup:''!!}
{!! !empty($home->og_meta)?$home->og_meta:'' !!}
{!! !empty($home->twitter_meta)?$home->twitter_meta:'' !!}
@endsection
@section('content')
            ...
            <div class="owl-carousel" data-autoplay="true" data-loop="true" data-nav="false" data-dots="true" data-items="4" data-items-laptop="4" data-items-tab="3" data-items-mobile="2" data-items-mobile-sm="1" data-margin="30">
                ...
                <div class="item wow fadeInLeft" data-wow-duration="1s">
                    <div class="iq-masonry-item creative design print-branding">
                        <a href="{{url('/research-reports/'.Str::slug(Str::replace('&','and',$category->category_name) , '-').'/'.$category->id)}}" class="">
                            <div class="iq-portfolio reports-cards">
                                <img src="{{ !empty($category->image_path) && Storage::exists($category->image_path) ? url('/').Storage::url($category->image_path) : URL::asset('admin_panel/commonarea/dist/img/default1.jpg') }}" class="w-100" alt="report-image">
                                <div class="iq-portfolio-content">
                                    <div class="details-box clearfix">
                                        <div class="consult-details">
                                            <h5 class="link-color mt-1">{{ !empty($category->category_name) ? $category->category_name : '' }}</h5>
                                            <div class="mb-0 iq-portfolio-desc">{!! !empty($category->description) ? substr(strip_tags($category->description), 0, 80) . ' ...' : '' !!}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="iq-masonry-item creative design print-branding">
                            <a href="" class="">
                                <div class="iq-portfolio">
                                    <img src="{{ URL::asset('admin_panel/commonarea/dist/img/default1.jpg') }}" class="w-100" alt="report-image">
                <div class="iq-portfolio-content">
                    <div class="details-box clearfix">
                        <div class="consult-details">
                            <h5 class="link-color mt-1">Agriculture</h5>
            ...
            <a href="" class="">
                <div class="iq-portfolio">
                    ...
                    <div class="iq-portfolio-content">
                        <div class="details-box clearfix">
                            <div class="consult-details">
                                <h5 class="link-color mt-1">Automotive & Transportation</h5>
                                <p class="mb-0 iq-portfolio-desc">
                                    There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.
                                </p>
                            </div>
            ...
            <a href="" class="">
                <div class="iq-portfolio">
                    ...
                    <div class="iq-portfolio-content">
                        <div class="details-box clearfix">
                            <div class="consult-details">
                                <h5 class="link-color mt-1">Banking & Finance</h5>
                                <p class="mb-0 iq-portfolio-desc">
                                    There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.
                                </p>
                            </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 wow fadeInRight">
                    <div class=" text-left iq-title-box iq-title-default iq-title-box-2 home-about_content">
                        ...
                        <h2 class="iq-title text-capitalize">
                            {{!empty($home->section_3_heading)?$home->section_3_heading:''}}
                        </h2>
                    ...
                    <div class="item wow fadeInLeft" data-wow-duration="1s">
                        <div class="iq-masonry-item creative design print-branding">
                            <a href="{{url('/reports/'.$reportData->url.'/'.$reportData->id)}}" class="">
                                <div class="iq-portfolio">
                                    {{-- <img src="{{ !empty($reportData->image_1_path)  && Storage::exists($reportData->image_1_path) ? url('/').Storage::url($reportData->image_1_path) : URL::asset('admin_panel/commonarea/dist/img/default1.jpg') }}" class="w-100" alt="{{ !empty($reportData->image_1_name) ? $reportData->image_1_name : '' }}"> --}}
                                    <img src="{{ URL::asset('admin_panel/commonarea/dist/img/default1.jpg') }}" class="w-100" alt="report-image">
                                    <div class="iq-portfolio-content">
                                        <div class="details-box clearfix">
                                            <div class="consult-details">
                                                <h5 class="link-color">{{!empty($reportData->title)?$reportData->title:''}}</h5>
                                                <p class="mb-0 iq-portfolio-desc">{{ substr(strip_tags(!empty($reportData->description)?$reportData->description:''), 0, 80) . ' ...'}}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="iq-blog-box" style="border: 1px solid #0071a1">
                                        <div class="iq-blog-image clearfix">
                                            ...
                                            <ul class="iq-blogtag">
                                                ...
                                                @endphp
                                                <li><a href="{{url('blog/'.$blogData->slug_url)}}">{{$formattedDate}}</a></li>
                                            </ul>
                                        ...
                                        <div class="iq-blog-detail">
                                            ...
                                            <div class="blog-title">
                                                <a href="{{url('blog/'.$blogData->slug_url)}}">
                                ...
                                <div class="iq-masonry-item" style="border: 1px solid #0071a1">
                                    <div class="iq-portfolio">
                                        ...
                                        <a href="{{url('press-release/'.(!empty($pressReleaseData->slug_url)?$pressReleaseData->slug_url:'#'))}}" class="iq-portfolio-img">
                                            {{-- <img src="{{!empty($pressReleaseData->image_path) && (Storage::exists($pressReleaseData->image_path)) ? url('/').Storage::url($pressReleaseData->image_path) : URL::asset('admin_panel/commonarea/dist/img/default.png')}}" class="img-fluid" alt="{{ !empty($pressReleaseData->image_name) ? $pressReleaseData->image_name : 'Press Release Image' }}" /> --}}
            ...
            <div class="row">
                <div class="col-lg-4 col-md-5 col-sm-12 align-self-center">
                    <div class=" text-left iq-title-box iq-title-default iq-title-box-2">
                        ...
                        <h2 class="iq-title">
                            {{!empty($home->section_6_heading)?$home->section_6_heading:''}}
                        </h2>
