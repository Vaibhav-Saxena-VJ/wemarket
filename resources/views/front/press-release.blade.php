                                    ...
                                    <div class="acc-card_content">
                                        <div class="acc-card_infos">
                                            {{-- <div class="press-list-img">
                                                <img src="{{!empty($pressData->image_path) && Storage::exists($pressData->image_path) ? url('/').Storage::url($pressData->image_path) : URL::asset('admin_panel/commonarea/dist/img/default1.jpg')}}" class="img-fluid w-100 press-release-list-img" alt="Forbes">
                                            </div> --}}
