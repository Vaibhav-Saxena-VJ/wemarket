...
@section('email_content')
    ...
    <div style="width: 100%; margin-bottom: 30px;">
        <div style="font-size: 16px; color: #000;">
            ...
            <p style="margin-bottom: 0px;margin-top: 5px;">Thank you for connecting with We Market Research. Your inquiry is valuable to us, and we'll be addressing it promptly.</p>
