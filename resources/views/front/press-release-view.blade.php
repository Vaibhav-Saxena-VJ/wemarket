...
@section('meta_keywords',!empty($press_release->meta_keyword)?$press_release->meta_keyword:'')

@section('meta_description', !empty($press_release->meta_description)?$press_release->meta_description:'')
@section('head')
<meta name='robots' content='index,follow, max-image-preview:large/' />
{!! !empty($press_release->schema_markup)?$press_release->schema_markup:'' !!}
{!! !empty($press_release->og_meta)?$press_release->og_meta:'' !!}
{!! !empty($press_release->twitter_meta)?$press_release->twitter_meta:'' !!}
@endsection
@section('content')
...
<!-- Breadcrumb End -->
<!-- Blog Start -->
<div class="iq-blog-section overview-block-ptb press-view-details">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                {{-- <div class="press-view-content_img">
                    <img src="{{ !empty($press_release->image_path) ? url('/').Storage::url($press_release->image_path) : URL::asset('admin_panel/commonarea/dist/img/default1.jpg') }}" class="img-fluid" alt="qloud" />
                </div> --}}
