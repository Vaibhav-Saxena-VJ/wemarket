...
@section('meta_keywords',!empty($terms_we_use->meta_keyword)?$terms_we_use->meta_keyword:'')

@section('meta_description', !empty($terms_we_use->meta_description)?$terms_we_use->meta_description:'')

@section('content')
@section('head')
<meta name='robots' content='index,follow, max-image-preview:large/' />
{!! !empty($terms_we_use->schema_markup)?$terms_we_use->schema_markup:''!!}
{!! !empty($terms_we_use->og_meta)?$terms_we_use->og_meta:'' !!}
{!! !empty($terms_we_use->twitter_meta)?$terms_we_use->twitter_meta:'' !!}
@endsection
<!-- Breadcrumb Start -->
<div class=" main-bg">
