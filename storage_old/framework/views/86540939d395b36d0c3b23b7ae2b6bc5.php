...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row no-margin">
            <form action="<?php echo e(url('/admin/report/export')); ?>" method="post" enctype="multipart/form-data" id="filter-form" >
            <?php echo csrf_field(); ?>
            <section class="content-header">
               <h1>All Reports
                    <div class="pull-right">
                        <span style="margin-right: 20px;">Total Reports - <span id="total_report_count" style="color: #ff0000;font-weight: 700;"><?php echo e($totalReportCount); ?></span></span>
                        <span style="margin-right: 20px;">Top Selling Reports- <span id="top_selling_report_count" style="color: #ff0000;font-weight: 700;"><?php echo e($totalTopSellingReportCount); ?></span></span>
                        
                        <?php if(!empty($RolesPrivileges) && str_contains($RolesPrivileges, 'report_other')): ?>
                        ...
                        <a type="button" href="<?php echo e(url('/admin/report/sample-report')); ?>">
                        ...
                        <?php endif; ?>
                        <?php if(!empty($RolesPrivileges) && str_contains($RolesPrivileges, 'report_add')): ?>
                        <a href="<?php echo e(url('admin/report/create')); ?>">
                                    ...
                                    <select class="form-control w-100" id="category_id" name="category_id">
                                        <?php if(!empty($categories)): ?>
                                            ...
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($category->id); ?>" <?php echo e(isset($report) && ($report->category_id == $category->id) ? 'selected' : '' ); ?>> <?php echo e($category->category_name); ?> </option>
                                                ...
                                                <table id="arm_data_table" class="table table-bordered dataTable no-footer">
                                                    <thead>
                                                        <tr role="row">
                                                            ...
                                                            <th width="10%" class="">Top Selling Reports</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="import-content">
                    ...
                    <form action="<?php echo e(url('admin/report/import')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <input type="file" class="form-control" id="import_report" name="import_report" accept=".xlsx, .xls, .csv">
                        <?php if($errors->has('import_report')): ?>
                            <span class="text-danger"><b>*</b> <?php echo e($errors->first('import_report')); ?></span>
                        <?php endif; ?>
...
<script src="<?php echo e(URL::asset('admin_panel/controller_js/cn_reports.js')); ?>"></script>
...
<?php echo $__env->make('admin.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wemarketresearch/public_html/resources/views/admin/all_reports/all_reports.blade.php ENDPATH**/ ?>