                    ...
                    <div class="col-sm-12">
                        <nav aria-label="breadcrumb" class="text-center iq-breadcrumb-two">
                            ...
                            <ol class="breadcrumb main-bg">
                                ...
                                <li class="breadcrumb-item active"><?php echo e(!empty($service->banner_heading)?$service->banner_heading:''); ?>- We Market Knowledge Based</li>
                            </ol>
                        </nav>
                    </div>
                </div>
...
<section class="pt-0">
    <div class="iq-blog-section service-view">
        <div class="service-view-img">
            <img src="<?php echo e(!empty($service->banner_image_path) && Storage::exists($service->banner_image_path) ? url('/').Storage::url($service->banner_image_path) : URL::asset('admin_panel/commonarea/dist/img/default1.jpg')); ?>" class="img-fluid w-100 service-view-img" alt="Forbes">
        </div>
        <div class="container">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wemarketresearch/public_html/resources/views/front/subscription.blade.php ENDPATH**/ ?>