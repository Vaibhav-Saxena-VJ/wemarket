                ...
                <div class="col-md-12">
                    <div class="iq-icon-box iq-icon-box-style-5 bg-white iq-box-shadow wow fadeInUp" data-wow-duration="0.7s" style="visibility: visible; animation-duration: 0.7s; animation-name: fadeInUp;">
                        <div class="icon-box-content">
                            <h6>Report Title:</h6>
                            <a href="<?php echo e(url('/reports/'.$report_details->url.'/'.$report_details->id)); ?>" class="icon-box-desc"><?php echo e(!empty($report_details->title) ? $report_details->title : ''); ?></a>
                            <p class="para-type">Report Format: <span>PPT, PDF, WORD, EXCEL</span></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                  <form action="<?php echo e(route('pay')); ?>" method="post" class="form wow fadeInRight" data-wow-duration="0.7s" id="payment_form">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="id" value="<?php echo e(!empty($report_details->id) ? $report_details->id : ''); ?>">
                    <div class="row">
                      <div class="col-lg-5 col-md-5">
                        <div class="plans-detail mb-4  wow fadeInLeft"  data-wow-duration="0.7s">
                            ...
                            <?php if($errors->has('license')): ?>
                                <span class="text-danger"><b>*</b> <?php echo e($errors->first('license')); ?></span>
                            <?php endif; ?>
                        </div>
                      </div>
                        ...
                        <div class="form-internal-content">
                          <div class="payment-mode">
                              ...
                              <div class="radio-inputs">
                                  <label>
                                      ...
                                      <span class="radio-tile">
                                          ...
                                          <img src="<?php echo e(URL::asset('front/images/new-images/payment/stripe.png')); ?>" alt="">
                                          </span>
                                  ...
                                  <label>
                                      ...
                                      <span class="radio-tile">
                                          <span class="radio-icon">
                                              <img src="<?php echo e(URL::asset('front/images/new-images/payment/paypal.png')); ?>" alt="">
                                          </span>
                              ...
                              <?php if($errors->has('payment_method')): ?>
                                  <span class="text-danger"><b>*</b> <?php echo e($errors->first('payment_method')); ?></span>
                              <?php endif; ?>
                          </div>
                          <div class="payment-form-content">
                              ...
                              <label>
                                  ...
                                  <?php if($errors->has('user_name')): ?>
                                      <span class="text-danger"><b>*</b> <?php echo e($errors->first('user_name')); ?></span>
                                  <?php endif; ?>
                              </label>
                              ...
                              <label>
                                  ...
                                  <?php if($errors->has('user_email')): ?>
                                      <span class="text-danger"><b>*</b> <?php echo e($errors->first('user_email')); ?></span>
                                  <?php endif; ?>
                              </label> 
                              ...
                              <div class="flex">
                                  <div class="form-group">
                                    ...
                                    <?php if($errors->has('country_code')): ?>
                                        <span class="text-danger"><b>*</b> <?php echo e($errors->first('country_code')); ?></span>
                                    <?php endif; ?>
                                  </div>
                                  ...
                                  <label>
                                      ...
                                      <?php if($errors->has('user_mobile')): ?>
                                          <span class="text-danger"><b>*</b> <?php echo e($errors->first('user_mobile')); ?></span>
                                      <?php endif; ?>
                                  </label>

                              </div>

                              <fieldset clss="MainCaptchaDiv">
                                  ...
                                  <div class="CaptchaDiv">
                                    ...
                                    <div class="d-flex-div">
                                      <label for="">
                                        <input type="text" id="capcha" class="CaptchaTxtField input" placeholder='' name="captcha">
                              ...
                              <button type="submit" class="Btn-pay">Pay
...
<script>
  $(document).ready(function(){
    var selected_license_type = "<?php echo e(!empty($license) ? $license : ''); ?>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wemarketresearch/public_html/resources/views/front/payment.blade.php ENDPATH**/ ?>