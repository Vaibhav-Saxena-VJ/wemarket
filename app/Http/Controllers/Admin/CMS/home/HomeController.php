...
class HomeController extends Controller
{
    ...
    public function show()
    {
        ...
        $categories = ReportCategory::where('status', 'active')->orderBy('id', 'desc')->get();
        return view('front.index', compact('home', 'testimonials','logo','banner','blogs','topSellingReports','pressRelease','latestBlogs','categories'));
    }
