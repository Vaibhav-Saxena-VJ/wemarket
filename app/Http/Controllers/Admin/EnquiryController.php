...
class EnquiryController extends Controller
{
    ...
    public function enquiry_data_table(Request $request) {
        ...
        $enquiry = $enquiry->orderBy('id', 'DESC')->select('id','request_type','report_title','created_at','name', 'email', 'mobile_number', 'designation', 'company_name', 'message','created_ip_address', 'country')->get();
    ...
    public function exportEnqueryData(Request $request)
    {
        ...
        $enquiry = $enquiry->orderBy('id', 'DESC')->select('id', 'request_type', 'report_title', 'created_at', 'name', 'email', 'mobile_number', 'designation', 'company_name', 'message', 'created_ip_address')->get();
