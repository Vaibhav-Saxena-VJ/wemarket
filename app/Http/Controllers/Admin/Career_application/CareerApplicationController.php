...
class CareerApplicationController extends Controller
{
        ...
        if($validator->passes()){
            ...
            if (!empty($data)) {
                ...
                try{
                    ...
                    \Mail::to($sales_email->email)->send(new CareerAplicationMail($mailData));
    ...
    public function  data_table(Request $request)
    {
        ...
        ->select('id', 'created_at','application_for','name','email','phone','designation','message','file_name','file_path', 'created_ip_address', 'country')
        ->get();
